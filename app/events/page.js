  ...
  return (
    <div className="min-h-screen pt-2 bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        {/* Events Grid */}
        <div className="grid grid-cols-1 gap-8 md:gap-16 mx-4 md:mx-24 lg:mx-48">
          {sortedEvents.map((event, index) => (
            <div key={index} className="bg-slate-800 rounded-xl p-4 md:p-8 card-glow hover:scale-103 transition-transform duration-300">
              <div className="mb-4 md:mb-6 flex flex-col sm:flex-row justify-between items-start gap-3">
                <span className={`px-3 py-1 md:px-4 md:py-2 rounded-full text-sm md:text-base font-semibold ${
                ...
                <span className="text-green-400 font-bold text-lg md:text-xl">{event.prize}</span>
              </div>
              
              <h3 className="text-xl md:text-3xl font-bold text-white mb-4 md:mb-6">{event.title}</h3>
              ...
              <p className="text-gray-300 text-sm md:text-lg leading-relaxed mb-6 md:mb-8">{event.description}</p>
              
              <button className="mt-4 md:mt-6 w-full sm:w-[30%] md:w-[15%] bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-2 md:py-3 text-sm md:text-lg rounded-lg hover:from-blue-700 hover:to-purple-700 transition-colors">
                Learn More
              </button>
            </div>
          ))}
